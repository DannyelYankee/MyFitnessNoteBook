...
public class phpInsertRutina extends Worker {

    public phpInsertRutina(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        System.out.println("User-> " + user + " rutina-> " + rutina);
        String server = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/djuape001/WEB/addRutina.php";
