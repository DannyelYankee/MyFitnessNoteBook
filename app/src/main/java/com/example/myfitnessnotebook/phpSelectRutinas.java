        ...
        try {
            ...
            if (statusCode == 200) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    rutinas.add(jsonArray.getJSONObject(i).getString("rutinas"));
                ...
                if (resultado.equals("false")) {
                    ...
                    datos = new Data.Builder().putBoolean("exito", true).putStringArray("rutinas",rutinas.toArray(new String[rutinas.size()])).build();
                }
